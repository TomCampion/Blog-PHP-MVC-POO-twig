...
trait RedisTrait
{
    ...
    private function init($redisClient, $namespace, $defaultLifetime, ?MarshallerInterface $marshaller)
    {
        ...
        if (!$redisClient instanceof Redis && !$redisClient instanceof RedisArray && !$redisClient instanceof \RedisCluster && !$redisClient instanceof Client && !$redisClient instanceof RedisProxy && !$redisClient instanceof RedisClusterProxy) {
     ...
     *
     * @return Redis|\RedisCluster|Client According to the "class" option
    ...
    public static function createConnection($dsn, array $options = [])
    {
        ...
        if (null === $params['class'] && extension_loaded('redis')) {
            ...
            $class = null === $params['class'] ? Client::class : $params['class'];
        }
    ...
    private function pipeline(Closure $generator)
    {
        ...
        if ($this->redis instanceof RedisClusterProxy || $this->redis instanceof \RedisCluster || ($this->redis instanceof Client && $this->redis->getConnection() instanceof RedisCluster)) {
